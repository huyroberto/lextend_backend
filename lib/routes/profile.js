module.exports = (function () {
    ...
    router.route('/register')
        .post(function (req, res) {
            ...
            backendService.getClient().exist(username, function (err, response) {
                if(err){
                ...
                try {
                    ...
                    backendService.getClient().createProfile(profile, function (err, response) {
                        if(err){
                                res.json({ response_code: '96', response_message: 'System Errors', data: err });       
                            }
                        console.log('create profile:');
    ...
    router.route('/')
        .get(function (req, res) {
            ...
            backendService.getClient().getProfile(auth_token, function (err, response) {
                if(err){
                                res.json({ response_code: '96', response_message: 'System Errors', data: err });       
                            }
