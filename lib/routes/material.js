module.exports = (function () {
    ...
    router.route('/recommended')
        .post(function (req, res) {
            ...
            var timezone = req.body.timezone || 'Asia/Saigon';

            console.log('Get Recommended Materials');
            backendService.getClient().getRecommendedMaterials(auth_token, langid, via_lang, timezone, false,
    ...
    router.route('/user_material')
        .post(function (req, res) {
            ...
            var langid = req.body.lang_id;
            var via_lang = req.body.lang_via_id;
            var pageToken = -1;// req.body.page;
            var limit = req.body.limit;

            console.log('List User Materials');
